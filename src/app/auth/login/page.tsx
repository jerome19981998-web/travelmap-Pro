    ...
    <div className="min-h-screen bg-[var(--surface-bg)] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">{t.welcomeBack}</h1>
          <p className="text-[var(--text-secondary)] text-sm mt-2">{t.signInToMap}</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs text-[var(--text-muted)]">{t.or}</span>
            <div className="flex-1 border-t border-[var(--surface-border)]" />
          </div>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-sm text-[var(--text-secondary)] mb-1.5">{t.email}</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm text-[var(--text-secondary)] mb-1.5">{t.password}</label>
              <input
                type="password"
                value={password}
