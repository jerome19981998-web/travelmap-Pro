...
import { Map, BarChart2, Heart, Trophy, Settings } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden glass-elevated border-t border-[var(--surface-border)] pb-safe">
